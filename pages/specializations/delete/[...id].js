...
export default function DeleteSpecialization() {
  ...
  async function deletedBlog() {
    await axios.delete("/api/specializations?id=" + id);
  ...
  return (
    <>
      <LoginLayout>
        <Head>
          <title>Delete Specialization</title>
        </Head>
        ...
        <div className="relative h-full p-8">
          <div className="titledashboard flex flex-sb">
            <div>
              <h2>
                Edit <span>{specializationInfo?.name}</span>
              </h2>
              <h3>ADMIN PANEL</h3>
            </div>
            <div className="breadcrumb">
              <SiBloglovin /> <span>/</span> <span>Delete Specialization</span>
            </div>
          </div>
